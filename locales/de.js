{
	...
	"Paste your secret in the text box. Create a link to your secret, the secret will be encrypted. Send the link to the recipient. The recipient can access the secret by this link. After the link has been accessed, the encrypted secret will be deleted. Following accesses will lead to an error message.": "Füge den geheimen Eintrag in die Text-Box. Erzeuge einen Link zu dem Eintrag, der Eintrag wird dabei verschlüsselt. Versende den Link, z.B. per Email. Der Empfänger kann den Eintrag über den Link ansehen. Nachdem der Eintrag EINMAL angesehen wurde, wird der Eintrag komplett gelöscht. Darauf folgende Zugriffe führen zu einer Fehlermeldung.",
